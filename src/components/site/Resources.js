        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>reactstap for a Bootstrap app</li>
                    <li>Font Awesome for React: https://gorangajic.githun.io/react-icons/fa.html</li>
                    ...
                    <li>https://ssetem.gitbooks.io/searchkit/docs/setup/projects/project-setup.html</li>
                    <li>https://www.fullstackreact.com/articles/react-tutorial-cloning-yelp</li>
                    <li>https://neptunian.github.io/react-photo-gallery/examples/basic.hmtl</li>
